...
describe "RealEx::Transaction" do
  ...
  it "should allow specifying of merchant_id and shared_secret at initialization time" do
    @transaction = RealEx::Authorization.new(
                    :card          => @card,
                    :amount        => 500,
                    :order_id      => 1234,
                    ...
                    :autosettle    => true,
                    :account       => "override",
                    :merchant_id   => "not_paul",
                    :shared_secret => "some_secret"
                  )
    @transaction.merchant_id.should == "not_paul"
    @transaction.shared_secret.should == "some_secret"
  end
